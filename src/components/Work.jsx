...
const Work = () => {
  ...
  return (
    <div id="work" className="section flex flex-col">
      ...
      <a href="https://github.com/Ammarkhan96" target='_blank' rel="noreferrer"><button className='font-mono block mx-auto mt-5 text-accent border-2 border-accent hover:bg-accent hover:text-black h-8 px-4 rounded-md leading-none transition-[250ms]'>View More on Github</button></a>
    </div>
  )
}
